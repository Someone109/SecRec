...
const REDIS_HOST = process.env.REDIS_HOST || "redisRateLimit";
const REDIS_PORT = process.env.REDIS_PORT || "16379";
const REDIS_URL =
  process.env.REDIS_URL || `rediss://${REDIS_HOST}:${REDIS_PORT}`;

const CA_PATH = process.env.REDIS_CA || "/run/secrets/redisRateLimit_ca.crt";
const KEY_PATH =
  process.env.REDIS_KEY || "/run/secrets/redisRateLimit_client.key";
const CERT_PATH =
  process.env.REDIS_CERT || "/run/secrets/redisRateLimit_client.crt";
